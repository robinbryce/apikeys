...
func TestParseAlg(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{"happy standard", args{alg: "argon2id:3 64MB 32"}, Alg{String: "argon2id:3 64MB 32", ParamsArgon2ID: ParamsArgon2ID{3, 64, 32}}, false},
		{"happy small and fast", args{alg: "argon2id:1 16MB 16"}, Alg{String: "argon2id:1 16MB 16", ParamsArgon2ID: ParamsArgon2ID{1, 16, 16}}, false},
